...
from protos import argmax_matcher_pb2 as protos_dot_argmax__matcher__pb2
from protos import bipartite_matcher_pb2 as protos_dot_bipartite__matcher__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='protos/matcher.proto',
  package='object_detection.protos',
  syntax='proto2',
  serialized_pb=_b('\n\x14protos/matcher.proto\x12\x17object_detection.protos\x1a\x1bprotos/argmax_matcher.proto\x1a\x1eprotos/bipartite_matcher.proto\"\xa4\x01\n\x07Matcher\x12@\n\x0e\x61rgmax_matcher\x18\x01 \x01(\x0b\x32&.object_detection.protos.ArgMaxMatcherH\x00\x12\x46\n\x11\x62ipartite_matcher\x18\x02 \x01(\x0b\x32).object_detection.protos.BipartiteMatcherH\x00\x42\x0f\n\rmatcher_oneof')
  ,
  dependencies=[protos_dot_argmax__matcher__pb2.DESCRIPTOR,protos_dot_bipartite__matcher__pb2.DESCRIPTOR,])
...
_MATCHER.fields_by_name['argmax_matcher'].message_type = protos_dot_argmax__matcher__pb2._ARGMAXMATCHER
_MATCHER.fields_by_name['bipartite_matcher'].message_type = protos_dot_bipartite__matcher__pb2._BIPARTITEMATCHER
