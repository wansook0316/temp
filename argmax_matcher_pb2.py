...
_ARGMAXMATCHER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ignore_sim_less_than_zero', full_name='object_detection.protos.ArgMaxMatcher.ignore_sim_less_than_zero', index=5,
