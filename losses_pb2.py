...
_HARDEXAMPLEMINER_BOXTYPE = _descriptor.EnumDescriptor(
  name='BoxType',
  full_name='object_detection.protos.HardExampleMiner.BoxType',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_HARDEXAMPLEMINER_BOXTYPE)
...
_HARDEXAMPLEMINER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='box_type', full_name='object_detection.protos.HardExampleMiner.box_type', index=5,
...
_HARDEXAMPLEMINER.fields_by_name['box_type'].enum_type = _HARDEXAMPLEMINER_BOXTYPE
_HARDEXAMPLEMINER_LOSSTYPE.containing_type = _HARDEXAMPLEMINER
_HARDEXAMPLEMINER_BOXTYPE.containing_type = _HARDEXAMPLEMINER
