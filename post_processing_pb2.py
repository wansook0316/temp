...
_sym_db.RegisterEnumDescriptor(_BATCHNONMAXSUPPRESSION_BOXTYPE)
...
_BATCHNONMAXSUPPRESSION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='box_type', full_name='object_detection.protos.BatchNonMaxSuppression.box_type', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='handle_as_single_class', full_name='object_detection.protos.BatchNonMaxSuppression.handle_as_single_class', index=5,
  ...
  nested_types=[],
  enum_types=[
    _BATCHNONMAXSUPPRESSION_BOXTYPE,
  ],
  options=None,
  is_extendable=False,
  syntax='proto2',
...
_BATCHNONMAXSUPPRESSION.fields_by_name['box_type'].enum_type = _BATCHNONMAXSUPPRESSION_BOXTYPE
_BATCHNONMAXSUPPRESSION_BOXTYPE.containing_type = _BATCHNONMAXSUPPRESSION
