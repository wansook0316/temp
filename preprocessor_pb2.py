...
_PREPROCESSINGSTEP = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='random_horizontal_flip_rbox', full_name='object_detection.protos.PreprocessingStep.random_horizontal_flip_rbox', index=23,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='random_vertical_flip_rbox', full_name='object_detection.protos.PreprocessingStep.random_vertical_flip_rbox', index=24,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='random_rotate_rbox', full_name='object_detection.protos.PreprocessingStep.random_rotate_rbox', index=25,
...
_RANDOMHORIZONTALFLIPRBOX = _descriptor.Descriptor(
  name='RandomHorizontalFlipRBox',
  full_name='object_detection.protos.RandomHorizontalFlipRBox',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_RANDOMVERTICALFLIPRBOX = _descriptor.Descriptor(
  name='RandomVerticalFlipRBox',
  full_name='object_detection.protos.RandomVerticalFlipRBox',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_RANDOMROTATERBOX = _descriptor.Descriptor(
  name='RandomRotateRBox',
  full_name='object_detection.protos.RandomRotateRBox',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='min_value', full_name='object_detection.protos.RandomRotateRBox.min_value', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(-0.17453292),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='max_value', full_name='object_detection.protos.RandomRotateRBox.max_value', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(0.17453292),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='by_90', full_name='object_detection.protos.RandomRotateRBox.by_90', index=2,
...
_PREPROCESSINGSTEP.fields_by_name['random_horizontal_flip_rbox'].message_type = _RANDOMHORIZONTALFLIPRBOX
_PREPROCESSINGSTEP.fields_by_name['random_vertical_flip_rbox'].message_type = _RANDOMVERTICALFLIPRBOX
_PREPROCESSINGSTEP.fields_by_name['random_rotate_rbox'].message_type = _RANDOMROTATERBOX
...
_PREPROCESSINGSTEP.oneofs_by_name['preprocessing_step'].fields.append(
  _PREPROCESSINGSTEP.fields_by_name['random_horizontal_flip_rbox'])
_PREPROCESSINGSTEP.fields_by_name['random_horizontal_flip_rbox'].containing_oneof = _PREPROCESSINGSTEP.oneofs_by_name['preprocessing_step']
_PREPROCESSINGSTEP.oneofs_by_name['preprocessing_step'].fields.append(
  _PREPROCESSINGSTEP.fields_by_name['random_vertical_flip_rbox'])
_PREPROCESSINGSTEP.fields_by_name['random_vertical_flip_rbox'].containing_oneof = _PREPROCESSINGSTEP.oneofs_by_name['preprocessing_step']
_PREPROCESSINGSTEP.oneofs_by_name['preprocessing_step'].fields.append(
  _PREPROCESSINGSTEP.fields_by_name['random_rotate_rbox'])
_PREPROCESSINGSTEP.fields_by_name['random_rotate_rbox'].containing_oneof = _PREPROCESSINGSTEP.oneofs_by_name['preprocessing_step']
...
DESCRIPTOR.message_types_by_name['RandomHorizontalFlipRBox'] = _RANDOMHORIZONTALFLIPRBOX
DESCRIPTOR.message_types_by_name['RandomVerticalFlipRBox'] = _RANDOMVERTICALFLIPRBOX
DESCRIPTOR.message_types_by_name['RandomRotateRBox'] = _RANDOMROTATERBOX
...
RandomHorizontalFlipRBox = _reflection.GeneratedProtocolMessageType('RandomHorizontalFlipRBox', (_message.Message,), dict(
  DESCRIPTOR = _RANDOMHORIZONTALFLIPRBOX,
  __module__ = 'protos.preprocessor_pb2'
  # @@protoc_insertion_point(class_scope:object_detection.protos.RandomHorizontalFlipRBox)
  ))
_sym_db.RegisterMessage(RandomHorizontalFlipRBox)

RandomVerticalFlipRBox = _reflection.GeneratedProtocolMessageType('RandomVerticalFlipRBox', (_message.Message,), dict(
  DESCRIPTOR = _RANDOMVERTICALFLIPRBOX,
  __module__ = 'protos.preprocessor_pb2'
  # @@protoc_insertion_point(class_scope:object_detection.protos.RandomVerticalFlipRBox)
  ))
_sym_db.RegisterMessage(RandomVerticalFlipRBox)

RandomRotateRBox = _reflection.GeneratedProtocolMessageType('RandomRotateRBox', (_message.Message,), dict(
  DESCRIPTOR = _RANDOMROTATERBOX,
  __module__ = 'protos.preprocessor_pb2'
  # @@protoc_insertion_point(class_scope:object_detection.protos.RandomRotateRBox)
  ))
_sym_db.RegisterMessage(RandomRotateRBox)
