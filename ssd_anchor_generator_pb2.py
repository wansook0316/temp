...
_SSDANCHORGENERATOR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='num_aspect_ration_of_middle_scale', full_name='object_detection.protos.SsdAnchorGenerator.num_aspect_ration_of_middle_scale', index=5,
